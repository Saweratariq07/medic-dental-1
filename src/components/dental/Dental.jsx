    ...
    <div className="bg">
     ...
     <div className="text-lg text-center">
            ...
            <span className="relative inline-block">
              <input
                type="text"
                className={`w-[110px] h-8 bg-transparent text-center border-white border-[1px] rounded px-2 outline-none focus:ring-0 focus:border-white placeholder-white text-[#facc15] font-bold
          ...
          the excellence of your dental health and care."
          </div> 
    ...
    <div className="flex gap-8">
      ...
      <div className="flex flex-col items-start justify-center w-full">
        ...
        <div>
          ...
          <h4 className='text-start ms-8'>For any inquiries, feel free to <a href="mailto:info@frenchparkmedicalcentre.ie" className='text-red-600 font-bold'>Email us</a> us for further information.</h4>
        </div>
        <div>
